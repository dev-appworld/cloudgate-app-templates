...
export function StatCard({ label, value, sub, accent = '#0d9488' }) {
  return (
    <div className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-4 shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-card-hover">
      ...
      <p className="font-display mt-2 text-[26px] font-semibold tabular-nums tracking-tight text-slate-900">{value}</p>
...
export function PageHeader({ title, subtitle, actions }) {
  return (
    <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <h1 className="font-display text-[30px] font-semibold leading-tight tracking-tight text-slate-900">{title}</h1>
