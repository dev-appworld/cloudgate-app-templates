...
export class SidebarComponent extends AppComponentBase implements OnInit {
  ...
  readonly defaultAppIcon = AppBranding.appIcon;
  ...
  onAppIconError(event: Event): void {
    const img = event.target as HTMLImageElement | null;
    if (!img || img.src.endsWith(this.defaultAppIcon)) {
      return;
    }
    this.appSession.clearTenantBrandingUrl();
    img.src = this.defaultAppIcon;
  }
