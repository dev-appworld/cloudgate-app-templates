...
import { ZeroRefreshTokenService } from '../auth/zero-refresh-token.service';
import { ZeroTemplateHttpConfigurationService } from './zero-template-http-configuration.service';

@NgModule({
  providers: [
    ApiServiceProxies.DemoPodcastServiceProxy,
    ApiServiceProxies.AvatarServiceProxy,
    ApiServiceProxies.PushNotificationServiceProxy,
    ApiServiceProxies.DataFileServiceProxy,
    ApiServiceProxies.CommsServiceProxy,
